...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  'zh-hans': {
    ...
    poweredBy: '– 由 <a href="https://docs.aigcs.chat" target="_blank" rel="noopener">AIGCS</a> 提供支持',
    visitorTitle: '访客评论',
    formName: '昵称',
    formEmail: '邮箱',
    formUrl: '网址',
  ...
  en: {
    ...
    poweredBy: '– Powered by <a href="https://docs.aigcs.chat" target="_blank" rel="noopener">AIGCS</a>',
  ...
  'zh-hant': {
    ...
    poweredBy: '– 由 <a href="https://docs.aigcs.chat" target="_blank" rel="noopener">AIGCS</a> 提供支援',
    visitorTitle: '訪客評論',
    formName: '暱稱',
    formEmail: '郵箱',
    formUrl: '網址',
  ...
  private renderCommentCard(type: 'ai' | 'visitor' | 'fedi', data: any): string {
    ...
    const contentHtml = isEditing
      ...
      : type === 'fedi'
        ...
        : `${emptyNote}${this.escapeHtml(data.content)}`
